...
local ufoSounds = audio.loadSound("Sounds/ufo.mp3")
local ufoSoundsChannel
...
local function moveAlien()
    Object.x = Object.x + scrollXSpeed
    Object.y = Object.y + scrollYSpeed
...
function scene:create( event )
    ...
    Object = display.newImageRect("Images/ufo.png", 250, 180)
